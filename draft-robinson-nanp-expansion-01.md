...
docname: draft-robinson-nanp-expansion-01
category: info
date: 2026-04-29
...
Systems that perform digit analysis MUST be updated to recognize the NPAX format. This includes SS7-based switching systems, SIP routing platforms, and number portability databases.
...
evaluation is necessary to avoid time-constrained or emergency implementation.
